...
import MinModulus.Generated.SHCSixNormalizedN67A36B23
...
theorem certificate67_a36
    (q : IncreasingFiveTail 65 (⟨36, by norm_num⟩ : Fin 61)) : ∃ code,
      validRelationCode code ∧
      relationZeroNat 67 (increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), q⟩) code = true := by
  ...
  · let c' : Fin (27 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨0, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 39 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b00 q'
  · let c' : Fin (26 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨1, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 40 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b01 q'
  · let c' : Fin (25 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨2, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 41 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b02 q'
  · let c' : Fin (24 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨3, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 42 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b03 q'
  · let c' : Fin (23 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨4, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 43 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b04 q'
  · let c' : Fin (22 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨5, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 44 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b05 q'
  · let c' : Fin (21 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨6, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 45 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b06 q'
  · let c' : Fin (20 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨7, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 46 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b07 q'
  · let c' : Fin (19 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨8, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 47 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b08 q'
  · let c' : Fin (18 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨9, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 48 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b09 q'
  · let c' : Fin (17 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨10, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 49 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b10 q'
  · let c' : Fin (16 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨11, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 50 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b11 q'
  · let c' : Fin (15 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨12, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 51 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b12 q'
  · let c' : Fin (14 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨13, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 52 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b13 q'
  · let c' : Fin (13 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨14, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 53 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b14 q'
  · let c' : Fin (12 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨15, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 54 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b15 q'
  · let c' : Fin (11 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨16, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 55 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b16 q'
  · let c' : Fin (10 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨17, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 56 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b17 q'
  · let c' : Fin (9 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨18, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 57 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b18 q'
  · let c' : Fin (8 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨19, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 58 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b19 q'
  · let c' : Fin (7 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨20, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 59 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b20 q'
  · let c' : Fin (6 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨21, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 60 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b21 q'
  · let c' : Fin (5 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨22, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 61 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b22 q'
  · let c' : Fin (4 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨23, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 62 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b23 q'
  · let c' : Fin (3 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨36, by norm_num⟩ : Fin 61), ⟨⟨24, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 38 63 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a36_b24 q'
