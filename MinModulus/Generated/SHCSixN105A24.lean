...
import MinModulus.Generated.SHCSixN105A24B03
...
import MinModulus.Generated.SHCSixN105A24B07
import MinModulus.Generated.SHCSixN105A24B08
import MinModulus.Generated.SHCSixN105A24B09
import MinModulus.Generated.SHCSixN105A24B10
import MinModulus.Generated.SHCSixN105A24B11
import MinModulus.Generated.SHCSixN105A24B12
import MinModulus.Generated.SHCSixN105A24B13
import MinModulus.Generated.SHCSixN105A24B14
import MinModulus.Generated.SHCSixN105A24B15
import MinModulus.Generated.SHCSixN105A24B16
import MinModulus.Generated.SHCSixN105A24B17
import MinModulus.Generated.SHCSixN105A24B18
import MinModulus.Generated.SHCSixN105A24B19
import MinModulus.Generated.SHCSixN105A24B20
import MinModulus.Generated.SHCSixN105A24B21
import MinModulus.Generated.SHCSixN105A24B22
import MinModulus.Generated.SHCSixN105A24B23
import MinModulus.Generated.SHCSixN105A24B24
...
theorem certificate105_a24
    (q : IncreasingFiveTail 55 (⟨24, by norm_num⟩ : Fin 51)) : ∃ code,
      validRelationCode code ∧
      relationZeroNat (values ⟨(⟨24, by norm_num⟩ : Fin 51), q⟩) code = true := by
  ...
  · let c' : Fin (29 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨0, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨25, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b00 q'
  · let c' : Fin (28 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨1, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨26, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b01 q'
  · let c' : Fin (27 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨2, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨27, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b02 q'
  · let c' : Fin (26 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨3, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨28, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b03 q'
  · let c' : Fin (25 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨4, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨29, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b04 q'
  · let c' : Fin (24 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨5, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨30, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b05 q'
  · let c' : Fin (23 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨6, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨31, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b06 q'
  · let c' : Fin (22 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨7, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨32, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b07 q'
  · let c' : Fin (21 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨8, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨33, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b08 q'
  · let c' : Fin (20 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨9, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨34, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b09 q'
  · let c' : Fin (19 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨10, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨35, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b10 q'
  · let c' : Fin (18 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨11, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨36, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b11 q'
  · let c' : Fin (17 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨12, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨37, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b12 q'
  · let c' : Fin (16 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨13, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨38, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b13 q'
  · let c' : Fin (15 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨14, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨39, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b14 q'
  · let c' : Fin (14 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨15, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨40, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b15 q'
  · let c' : Fin (13 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨16, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨41, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b16 q'
  · let c' : Fin (12 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨17, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨42, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b17 q'
  · let c' : Fin (11 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨18, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨43, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b18 q'
  · let c' : Fin (10 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨19, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨44, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b19 q'
  · let c' : Fin (9 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨20, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨45, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b20 q'
  · let c' : Fin (8 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨21, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨46, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b21 q'
  · let c' : Fin (7 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨22, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨47, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b22 q'
  · let c' : Fin (6 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨23, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨48, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b23 q'
  · let c' : Fin (5 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨24, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨49, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b24 q'
  · let c' : Fin (4 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨25, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨50, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b25 q'
  · let c' : Fin (3 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨24, by norm_num⟩ : Fin 51), ⟨⟨26, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨24, by norm_num⟩ : Fin 55) (⟨51, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a24_b26 q'
