...
import MinModulus.Generated.SHCSixNormalizedN69A06B04
import MinModulus.Generated.SHCSixNormalizedN69A06B05
import MinModulus.Generated.SHCSixNormalizedN69A06B06
...
import MinModulus.Generated.SHCSixNormalizedN69A06B20
...
import MinModulus.Generated.SHCSixNormalizedN69A06B26
import MinModulus.Generated.SHCSixNormalizedN69A06B27
import MinModulus.Generated.SHCSixNormalizedN69A06B28
import MinModulus.Generated.SHCSixNormalizedN69A06B29
...
import MinModulus.Generated.SHCSixNormalizedN69A06B40
...
theorem certificate69_a06
    (q : IncreasingFiveTail 67 (⟨6, by norm_num⟩ : Fin 63)) : ∃ code,
      validRelationCode code ∧
      relationZeroNat 69 (increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), q⟩) code = true := by
  ...
  · let c' : Fin (59 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨0, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 9 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b00 q'
  · let c' : Fin (58 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨1, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 10 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b01 q'
  · let c' : Fin (57 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨2, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 11 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b02 q'
  · let c' : Fin (56 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨3, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 12 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b03 q'
  · let c' : Fin (55 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨4, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 13 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b04 q'
  · let c' : Fin (54 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨5, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 14 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b05 q'
  · let c' : Fin (53 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨6, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 15 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b06 q'
  · let c' : Fin (52 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨7, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 16 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b07 q'
  · let c' : Fin (51 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨8, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 17 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b08 q'
  · let c' : Fin (50 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨9, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 18 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b09 q'
  · let c' : Fin (49 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨10, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 19 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b10 q'
  · let c' : Fin (48 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨11, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 20 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b11 q'
  · let c' : Fin (47 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨12, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 21 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b12 q'
  · let c' : Fin (46 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨13, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 22 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b13 q'
  · let c' : Fin (45 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨14, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 23 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b14 q'
  · let c' : Fin (44 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨15, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 24 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b15 q'
  · let c' : Fin (43 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨16, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 25 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b16 q'
  · let c' : Fin (42 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨17, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 26 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b17 q'
  · let c' : Fin (41 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨18, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 27 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b18 q'
  · let c' : Fin (40 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨19, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 28 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b19 q'
  · let c' : Fin (39 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨20, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 29 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b20 q'
  · let c' : Fin (38 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨21, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 30 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b21 q'
  · let c' : Fin (37 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨22, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 31 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b22 q'
  · let c' : Fin (36 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨23, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 32 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b23 q'
  · let c' : Fin (35 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨24, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 33 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b24 q'
  · let c' : Fin (34 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨25, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 34 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b25 q'
  · let c' : Fin (33 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨26, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 35 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b26 q'
  · let c' : Fin (32 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨27, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 36 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b27 q'
  · let c' : Fin (31 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨28, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 37 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b28 q'
  · let c' : Fin (30 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨29, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 38 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b29 q'
  · let c' : Fin (29 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨30, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 39 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b30 q'
  · let c' : Fin (28 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨31, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 40 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b31 q'
  · let c' : Fin (27 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨32, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 41 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b32 q'
  · let c' : Fin (26 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨33, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 42 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b33 q'
  · let c' : Fin (25 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨34, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 43 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b34 q'
  · let c' : Fin (24 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨35, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 44 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b35 q'
  · let c' : Fin (23 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨36, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 45 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b36 q'
  · let c' : Fin (22 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨37, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 46 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b37 q'
  · let c' : Fin (21 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨38, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 47 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b38 q'
  · let c' : Fin (20 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨39, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 48 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b39 q'
  · let c' : Fin (19 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨40, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 49 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b40 q'
  · let c' : Fin (18 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨41, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 50 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b41 q'
  · let c' : Fin (17 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨42, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 51 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b42 q'
  · let c' : Fin (16 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨43, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 52 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b43 q'
  · let c' : Fin (15 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨44, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 53 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b44 q'
  · let c' : Fin (14 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨45, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 54 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b45 q'
  · let c' : Fin (13 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨46, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 55 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b46 q'
  · let c' : Fin (12 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨47, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 56 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b47 q'
  · let c' : Fin (11 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨48, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 57 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b48 q'
  · let c' : Fin (10 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨49, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 58 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b49 q'
  · let c' : Fin (9 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨50, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 59 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b50 q'
  · let c' : Fin (8 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨51, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 60 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b51 q'
  · let c' : Fin (7 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨52, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 61 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b52 q'
  · let c' : Fin (6 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨53, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 62 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b53 q'
  · let c' : Fin (5 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨54, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 63 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b54 q'
  · let c' : Fin (4 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨55, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 64 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b55 q'
  · let c' : Fin (3 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨6, by norm_num⟩ : Fin 63), ⟨⟨56, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 8 65 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a06_b56 q'
