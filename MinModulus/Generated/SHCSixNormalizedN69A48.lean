...
import MinModulus.Generated.SHCSixNormalizedN69A48B04
...
theorem certificate69_a48
    (q : IncreasingFiveTail 67 (⟨48, by norm_num⟩ : Fin 63)) : ∃ code,
      validRelationCode code ∧
      relationZeroNat 69 (increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), q⟩) code = true := by
  ...
  · let c' : Fin (17 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨0, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 51 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b00 q'
  · let c' : Fin (16 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨1, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 52 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b01 q'
  · let c' : Fin (15 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨2, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 53 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b02 q'
  · let c' : Fin (14 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨3, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 54 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b03 q'
  · let c' : Fin (13 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨4, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 55 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b04 q'
  · let c' : Fin (12 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨5, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 56 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b05 q'
  · let c' : Fin (11 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨6, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 57 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b06 q'
  · let c' : Fin (10 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨7, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 58 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b07 q'
  · let c' : Fin (9 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨8, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 59 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b08 q'
  · let c' : Fin (8 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨9, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 60 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b09 q'
  · let c' : Fin (7 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨10, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 61 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b10 q'
  · let c' : Fin (6 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨11, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 62 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b11 q'
  · let c' : Fin (5 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨12, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 63 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b12 q'
  · let c' : Fin (4 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨13, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 64 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b13 q'
  · let c' : Fin (3 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 69) ⟨(⟨48, by norm_num⟩ : Fin 63), ⟨⟨14, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 50 65 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate69_a48_b14 q'
