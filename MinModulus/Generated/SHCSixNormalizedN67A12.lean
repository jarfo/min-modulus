...
import MinModulus.Generated.SHCSixNormalizedN67A12B10
import MinModulus.Generated.SHCSixNormalizedN67A12B11
...
import MinModulus.Generated.SHCSixNormalizedN67A12B30
import MinModulus.Generated.SHCSixNormalizedN67A12B31
import MinModulus.Generated.SHCSixNormalizedN67A12B32
...
theorem certificate67_a12
    (q : IncreasingFiveTail 65 (⟨12, by norm_num⟩ : Fin 61)) : ∃ code,
      validRelationCode code ∧
      relationZeroNat 67 (increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), q⟩) code = true := by
  ...
  · let c' : Fin (51 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨0, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 15 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b00 q'
  · let c' : Fin (50 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨1, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 16 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b01 q'
  · let c' : Fin (49 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨2, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 17 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b02 q'
  · let c' : Fin (48 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨3, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 18 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b03 q'
  · let c' : Fin (47 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨4, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 19 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b04 q'
  · let c' : Fin (46 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨5, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 20 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b05 q'
  · let c' : Fin (45 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨6, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 21 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b06 q'
  · let c' : Fin (44 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨7, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 22 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b07 q'
  · let c' : Fin (43 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨8, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 23 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b08 q'
  · let c' : Fin (42 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨9, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 24 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b09 q'
  · let c' : Fin (41 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨10, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 25 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b10 q'
  · let c' : Fin (40 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨11, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 26 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b11 q'
  · let c' : Fin (39 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨12, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 27 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b12 q'
  · let c' : Fin (38 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨13, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 28 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b13 q'
  · let c' : Fin (37 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨14, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 29 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b14 q'
  · let c' : Fin (36 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨15, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 30 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b15 q'
  · let c' : Fin (35 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨16, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 31 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b16 q'
  · let c' : Fin (34 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨17, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 32 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b17 q'
  · let c' : Fin (33 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨18, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 33 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b18 q'
  · let c' : Fin (32 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨19, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 34 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b19 q'
  · let c' : Fin (31 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨20, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 35 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b20 q'
  · let c' : Fin (30 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨21, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 36 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b21 q'
  · let c' : Fin (29 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨22, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 37 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b22 q'
  · let c' : Fin (28 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨23, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 38 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b23 q'
  · let c' : Fin (27 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨24, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 39 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b24 q'
  · let c' : Fin (26 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨25, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 40 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b25 q'
  · let c' : Fin (25 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨26, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 41 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b26 q'
  · let c' : Fin (24 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨27, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 42 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b27 q'
  · let c' : Fin (23 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨28, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 43 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b28 q'
  · let c' : Fin (22 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨29, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 44 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b29 q'
  · let c' : Fin (21 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨30, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 45 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b30 q'
  · let c' : Fin (20 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨31, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 46 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b31 q'
  · let c' : Fin (19 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨32, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 47 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b32 q'
  · let c' : Fin (18 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨33, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 48 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b33 q'
  · let c' : Fin (17 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨34, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 49 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b34 q'
  · let c' : Fin (16 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨35, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 50 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b35 q'
  · let c' : Fin (15 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨36, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 51 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b36 q'
  · let c' : Fin (14 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨37, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 52 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b37 q'
  · let c' : Fin (13 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨38, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 53 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b38 q'
  · let c' : Fin (12 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨39, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 54 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b39 q'
  · let c' : Fin (11 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨40, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 55 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b40 q'
  · let c' : Fin (10 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨41, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 56 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b41 q'
  · let c' : Fin (9 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨42, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 57 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b42 q'
  · let c' : Fin (8 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨43, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 58 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b43 q'
  · let c' : Fin (7 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨44, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 59 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b44 q'
  · let c' : Fin (6 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨45, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 60 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b45 q'
  · let c' : Fin (5 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨46, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 61 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b46 q'
  · let c' : Fin (4 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨47, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 62 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b47 q'
  · let c' : Fin (3 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : increasingFiveValues (N := 67) ⟨(⟨12, by norm_num⟩ : Fin 61), ⟨⟨48, by norm_num⟩, c, d, e⟩⟩ =
        blockValues 14 63 q' := by
      funext i
      fin_cases i <;> simp [increasingFiveValues, blockValues, q', c', d', e'] <;> omega
    rw [hv]
    exact certificate67_a12_b48 q'
