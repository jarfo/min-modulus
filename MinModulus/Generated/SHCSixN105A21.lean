...
import MinModulus.Generated.SHCSixN105A21B05
import MinModulus.Generated.SHCSixN105A21B06
import MinModulus.Generated.SHCSixN105A21B07
import MinModulus.Generated.SHCSixN105A21B08
import MinModulus.Generated.SHCSixN105A21B09
import MinModulus.Generated.SHCSixN105A21B10
import MinModulus.Generated.SHCSixN105A21B11
import MinModulus.Generated.SHCSixN105A21B12
import MinModulus.Generated.SHCSixN105A21B13
import MinModulus.Generated.SHCSixN105A21B14
import MinModulus.Generated.SHCSixN105A21B15
import MinModulus.Generated.SHCSixN105A21B16
import MinModulus.Generated.SHCSixN105A21B17
import MinModulus.Generated.SHCSixN105A21B18
import MinModulus.Generated.SHCSixN105A21B19
import MinModulus.Generated.SHCSixN105A21B20
import MinModulus.Generated.SHCSixN105A21B21
import MinModulus.Generated.SHCSixN105A21B22
import MinModulus.Generated.SHCSixN105A21B23
import MinModulus.Generated.SHCSixN105A21B24
import MinModulus.Generated.SHCSixN105A21B25
import MinModulus.Generated.SHCSixN105A21B26
import MinModulus.Generated.SHCSixN105A21B27
...
theorem certificate105_a21
    (q : IncreasingFiveTail 55 (⟨21, by norm_num⟩ : Fin 51)) : ∃ code,
      validRelationCode code ∧
      relationZeroNat (values ⟨(⟨21, by norm_num⟩ : Fin 51), q⟩) code = true := by
  ...
  · let c' : Fin (32 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨0, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨22, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b00 q'
  · let c' : Fin (31 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨1, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨23, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b01 q'
  · let c' : Fin (30 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨2, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨24, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b02 q'
  · let c' : Fin (29 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨3, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨25, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b03 q'
  · let c' : Fin (28 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨4, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨26, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b04 q'
  · let c' : Fin (27 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨5, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨27, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b05 q'
  · let c' : Fin (26 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨6, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨28, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b06 q'
  · let c' : Fin (25 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨7, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨29, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b07 q'
  · let c' : Fin (24 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨8, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨30, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b08 q'
  · let c' : Fin (23 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨9, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨31, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b09 q'
  · let c' : Fin (22 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨10, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨32, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b10 q'
  · let c' : Fin (21 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨11, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨33, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b11 q'
  · let c' : Fin (20 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨12, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨34, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b12 q'
  · let c' : Fin (19 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨13, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨35, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b13 q'
  · let c' : Fin (18 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨14, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨36, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b14 q'
  · let c' : Fin (17 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨15, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨37, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b15 q'
  · let c' : Fin (16 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨16, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨38, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b16 q'
  · let c' : Fin (15 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨17, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨39, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b17 q'
  · let c' : Fin (14 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨18, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨40, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b18 q'
  · let c' : Fin (13 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨19, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨41, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b19 q'
  · let c' : Fin (12 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨20, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨42, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b20 q'
  · let c' : Fin (11 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨21, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨43, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b21 q'
  · let c' : Fin (10 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨22, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨44, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b22 q'
  · let c' : Fin (9 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨23, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨45, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b23 q'
  · let c' : Fin (8 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨24, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨46, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b24 q'
  · let c' : Fin (7 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨25, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨47, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b25 q'
  · let c' : Fin (6 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨26, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨48, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b26 q'
  · let c' : Fin (5 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨27, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨49, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b27 q'
  · let c' : Fin (4 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨28, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨50, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b28 q'
  · let c' : Fin (3 - 2) := ⟨c.val, by have hc := c.isLt; dsimp only at hc; omega⟩
    ...
    have hv : values ⟨(⟨21, by norm_num⟩ : Fin 51), ⟨⟨29, by norm_num⟩, c, d, e⟩⟩ =
        blockValues (⟨21, by norm_num⟩ : Fin 55) (⟨51, by norm_num⟩ : Fin 55) q' := by
      funext i
      fin_cases i <;> rfl
    rw [hv]
    exact certificate105_a21_b29 q'
