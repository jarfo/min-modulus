...
/-- Deletion obligation for the displayed tail-heavy pure-edge residual. -/
def CriticalTailHeavyPureEdgeDeleteStepFromSeven : Prop :=
  ∀ {n s q : ℕ} (_hn : 7 ≤ n) (_hq : Odd q)
...
theorem criticalRangeDeleteStepFromSeven_of_localHeavyResiduals
    ...
    (hpure : CriticalTailHeavyPureEdgeDeleteStepFromSeven)
