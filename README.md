...
| `SHCFiveCertificate.lean`, `Generated/SHCFiveN*.lean`, `SHCFiveBaseCases.lean` | trusted relation-code bridge and sharded kernel checks prove the first five normalized five-coordinate exclusions: order 33 analytically by the bottom wedge and every odd order 35–41 by generated certificates |
